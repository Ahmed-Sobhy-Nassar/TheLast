...
#include "TheLast/HUD/Announcement.h"
...
void ABlasterPlayerController::SetHUDTime()
{
	...
	else if (MatchState == MatchState::Cooldown) TimeLeft = CooldownTime + WarmupTime + MatchTime - GetServerTime() + LevelStartingTime; // {code 132}

...
#include "TheLast/Interfaces/InteractWithCrosshairInterface.h"
#include "Components/TimelineComponent.h"
#include "TheLast/BlasterTypes/CombatState.h"
#include "BlasterCharacter.generated.h"	

UCLASS()
class THELAST_API ABlasterCharacter : public ACharacter, public IInteractWithCrosshairInterface
{
	GENERATED_BODY()
public:
	ABlasterCharacter();
